...
const Loader = () => {
  return (
    <div className="flex justify-center items-center h-screen w-screen bg-gray-400">
     <ul className="border-4 border-indigo-600 rounded-full w-52 h-11 flex justify-center items-center p-0 m-0 bg-gray-100 cursor-pointer transition ease-in-out duration-200 relative">
